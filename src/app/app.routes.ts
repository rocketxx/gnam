...
export const routes: Routes = [
    ...
    { path: 'cart', title: 'Carrello', component: CartPageComponent },
    ...
    { path: 'modifica-menu/:id', title: 'Modifica menu', component: MenuRistoranteComponent },
    { path: 'lista-menu', title: 'Lista menu', component: ListaMenuComponent },
